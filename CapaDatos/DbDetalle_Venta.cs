...
namespace CapaDatos
{
    public class DbDetalle_Venta :DbConnection
    {
        ...
        public DbDetalle_Venta()
        {

        }

        public DbDetalle_Venta(int iddetalle_venta, int idventa, int iddetalle_ingreso,
        ...
        public string Insertar(DbDetalle_Venta Detalle_Venta, ref SqlConnection Sqlcon, ref SqlTransaction SqlTra)
        {
            string rpta = "";
            try
            {
