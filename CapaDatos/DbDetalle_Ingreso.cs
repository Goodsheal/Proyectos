...
namespace CapaDatos
{
    public class DbDetalle_Ingreso : DbConnection
    {
        ...
        public DbDetalle_Ingreso()
        {

        }
        public DbDetalle_Ingreso(int iddetalle_ingreso, int idingreso,
        ...
        public string Insertar(DbDetalle_Ingreso Detalle_Ingreso, ref SqlConnection Sqlcon, ref SqlTransaction SqlTra) 
        {
            string rpta = "";
            try
            {
