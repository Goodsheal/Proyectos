...
namespace ApptPedido
{
    public partial class FmrIngreso : Form
    {
        ...
        private static FmrIngreso _instancia;

        public static FmrIngreso GetInstancia()
        {
            if (_instancia == null)
            {
                _instancia = new FmrIngreso();
            }
            return _instancia;
        }
        ...
        private void FmrIngreso_FormClosing(object sender, FormClosingEventArgs e)
        {
            _instancia = null;
        ...
        {
            FmrVistaProveedor_Ingreso vista = new FmrVistaProveedor_Ingreso();
            vista.ShowDialog();
        }

        private void btnBuscarArticulo_Click(object sender, EventArgs e)
        {
            FmrVistaArticulo_Ingreso vista = new FmrVistaArticulo_Ingreso();
            vista.ShowDialog();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            FmrStockArticulo fmr = new FmrStockArticulo();
            fmr.ShowDialog();
        }
