...
namespace ApptPedido
{
    public partial class FmrArticulo : Form
    {
        ...
        private static FmrArticulo _Instancia;

        public static FmrArticulo GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FmrArticulo();
            }
            return _Instancia;
        }
        ...
        private void Limpiar()
        {
            ...
            this.pxImagen.Image = global::ApptPedido.Properties.Resources.file;
        }
        ...
        {
            FmrVistaCategoria_Articulo form = new FmrVistaCategoria_Articulo();
            form.ShowDialog();
        }

        private void btnImprimir_Click(object sender, EventArgs e)
        {
           FmrReporteArticulo fmr = new FmrReporteArticulo();
           fmr.ShowDialog();
        }

        private void FmrArticulo_FormClosing(object sender, FormClosingEventArgs e)
        {
            _Instancia = null;
        }
