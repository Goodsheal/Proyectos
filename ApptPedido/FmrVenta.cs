...
namespace ApptPedido
{
    public partial class FmrVenta : Form
    {
        ...
        private static FmrVenta _instancia;
        public static FmrVenta GetInstancia()
        {
            if (_instancia == null)
            {
                _instancia = new FmrVenta();
            }
            return _instancia;
        }
        ...
        private void FmrVenta_Load(object sender, EventArgs e)
        {
            this.Top = 0;
            this.Left = 0;
            this.Mostrar();
        ...
        {
            FmrVistaCliente_Venta vista = new FmrVistaCliente_Venta();
            vista.ShowDialog();
        }

        private void btnBuscarArticulo_Click(object sender, EventArgs e)
        {
            FmrVistaArticulo_Venta vista = new FmrVistaArticulo_Venta();
            vista.ShowDialog();
        }
        ...
        {
            FmrFactura fmr = new FmrFactura ();
            fmr.Idventa = Convert.ToInt32(this.dataListado.CurrentRow.Cells["idventa"].Value);
            fmr.ShowDialog();
        }
        ...
        private void FmrVenta_FormClosing(object sender, FormClosingEventArgs e)
        {
            _instancia = null;
